			              	...
			              	<table id="joblog_list" class="table table-bordered table-striped display" width="100%" >
								...
								<#list list as group>
									<tr>
                                        ...
                                        <td>${group.appName}</td>
                                        <td>${group.title}</td>
                                        <td><#if group.addressType==0>${I18n.jobgroup_field_addressType_0}</#if>
                                        <#if group.addressType==1>${I18n.jobgroup_field_addressType_1}</#if><#if group.addressType==2>${I18n.jobgroup_field_addressType_2}</#if></td>
                                        <td>
										...
										<td>
                                            <button class="btn btn-warning btn-xs update"
                                                    ...
                                                    addressList="${group.addressList!'unknown'}" >${I18n.system_opt_edit}</button>
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="radio" name="addressType" value="2" checked/>${I18n.jobgroup_field_addressType_2}
                                &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form" >
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">AppName(Eureka录入的不要修改)<font color="red">*</font></label>
                            <div class="col-sm-10"><input type="text" class="form-control" name="appName" placeholder="${I18n.system_please_input}AppName" maxlength="64" ></div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">${I18n.jobgroup_field_title}<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">${I18n.jobgroup_field_addressType}<font color="red">*</font></label>
                            <div class="col-sm-10">
                                <input type="radio" name="addressType" value="2" />${I18n.jobgroup_field_addressType_2}
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="addressType" value="0" />${I18n.jobgroup_field_addressType_0}
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="addressType" value="1" />${I18n.jobgroup_field_addressType_1}
