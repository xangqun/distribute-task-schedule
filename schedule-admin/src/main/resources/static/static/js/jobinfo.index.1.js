$(function() {
	...
	var addModalValidate = $("#addModal .form").validate({
        ...
        submitHandler : function(form) {
        	...
        	// process
            var executeTimeout = $("#addModal .form input[name='executeTimeout']").val();
            if(!/^\d+$/.test(executeTimeout)) {
            	executeTimeout = 0;
			}
            $("#addModal .form input[name='executeTimeout']").val(executeTimeout);
	...
	var updateModalValidate = $("#updateModal .form").validate({
        ...
        submitHandler : function(form) {
        	...
        	// process
            var executeTimeout = $("#updateModal .form input[name='executeTimeout']").val();
            if(!/^\d+$/.test(executeTimeout)) {
            	executeTimeout = 0;
            }
            $("#updateModal .form input[name='executeTimeout']").val(executeTimeout);
