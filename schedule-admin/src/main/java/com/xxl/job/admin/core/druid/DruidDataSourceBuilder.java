...
public class DruidDataSourceBuilder {
     ...
     * 如果你不存在上述问题或者使用 .yml 进行配置则不必使用该方法，使用上面的{@link com.alibaba.druid.spring.boot.autoconfigure.DruidDataSourceBuilder#build}即可，Spring Boot 2.0 修复了该问题，该方法届时也会停用。
     */
