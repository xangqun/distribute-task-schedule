...
public class MailUtil {
	...
	public static boolean sendMail(String toAddress, String mailSubject, String mailBody){
		...
		try {
			...
			email.setAuthenticator(new DefaultAuthenticator(XxlJobAdminConfig.getAdminConfig().getMailUsername(), StringUtils.isBlank(XxlJobAdminConfig.getAdminConfig().getMailPassword())?null:XxlJobAdminConfig.getAdminConfig().getMailPassword()));
