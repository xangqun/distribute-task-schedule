...
public class JobFailMonitorHelper {
	...
	private static LinkedBlockingQueue<Integer> queue = new LinkedBlockingQueue<Integer>(0xfff8);
			...
			public void run() {
				...
				while (!toStop) {
					try {
						...
						int drainToNum = queue.drainTo(jobLogIdList);
	...
	public static void monitor(int jobLogId){
		queue.offer(jobLogId);
	}


	// ---------------------- alarm ----------------------
   // email alarm template
	private final String mailBodyTemplate = "<h5>" + I18nUtil.getString("jobconf_monitor_detail") + "：</span>" +
